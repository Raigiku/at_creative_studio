...
REM --- 1. Always rebuild the binary. ---
REM
REM The Go binary embeds the static/ directory at compile time via
REM //go:embed. To avoid the "I edited app.js and nothing changed"
REM trap, we always rebuild before launching — no mtime check, no
REM shortcut. The dev loop is "edit → start script → see the change".
